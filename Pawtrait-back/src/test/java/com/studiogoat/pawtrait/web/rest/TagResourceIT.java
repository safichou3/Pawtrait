...
import com.studiogoat.pawtrait.repository.TagRepository;
import com.studiogoat.pawtrait.service.dto.TagDTO;
import com.studiogoat.pawtrait.service.mapper.TagMapper;
...
class TagResourceIT {
    ...
    public static Tag createEntity() {
        Tag tag = new Tag().name(DEFAULT_NAME).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT).deletedAt(DEFAULT_DELETED_AT);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity() {
        Tag tag = new Tag().name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT).deletedAt(UPDATED_DELETED_AT);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getDeletedAt()).isEqualTo(DEFAULT_DELETED_AT);
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT).deletedAt(UPDATED_DELETED_AT);
        ...
        assertThat(testTag.getDeletedAt()).isEqualTo(UPDATED_DELETED_AT);
    }
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).updatedAt(UPDATED_UPDATED_AT).deletedAt(UPDATED_DELETED_AT);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT).deletedAt(UPDATED_DELETED_AT);
