...
import com.studiogoat.pawtrait.service.ApplicationUserService;
...
/**
 * REST controller for managing {@link com.studiogoat.pawtrait.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
public class ApplicationUserResource {
    ...
    public ResponseEntity<ApplicationUserDTO> updateApplicationUser(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, applicationUserDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ApplicationUserDTO> partialUpdateApplicationUser(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, applicationUserDTO.getId())
        );
    }
