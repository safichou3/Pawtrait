...
import com.studiogoat.pawtrait.service.ReportService;
...
/**
 * REST controller for managing {@link com.studiogoat.pawtrait.domain.Report}.
 */
@RestController
@RequestMapping("/api")
public class ReportResource {
    ...
    public ResponseEntity<ReportDTO> updateReport(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ReportDTO> partialUpdateReport(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportDTO.getId())
        );
    }
